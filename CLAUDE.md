...
**下一步（Session 5）二選一、待使用者決定**：
- **選項 A**：Layer 4 整合 — Streamlit demo 加 Multi + HONI + NNI **三個** renderer（2-3h、含 HNI vs NNI 對比 tile）
- **選項 B**：NNI_ha port — 2020 paper 的 `Test_Heig2.m` benchmark 重現（2-4h、halving path 覆蓋）
